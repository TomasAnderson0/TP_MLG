...
```{r}
# De momento nos quedamos con el modelo 2 que tiene enlace logit
mod_sin_season
...
# Razones de ODDS
```{r}
# Comparo diametros con un incremento en 1cm

RO_diameter <- exp(5*0.05324)

# Comparo los tipos de sombrero

RO_hundido <- exp(-0.73106)
RO_otro <- exp(-1.84097)
RO_redondo <- exp(-0.82245)

table(muestra$class, muestra$cap_shape)
# Comparo los colores
```
