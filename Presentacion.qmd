...
# Curva para "mod_1"
par(pty = "s") # Para que grafique sólo en el (0;1)
ggroc(roc(muestra$class, fitted(mod_1)), col = "olivedrab2") + 
  geom_abline(slope = 1, intercept = 1, alpha = .5) + 
...
Se tienen entonces las siguientes medidas:
\begin{table}[]
\begin{tabular}{lccccc}
\hline
\multicolumn{1}{c}{Modelo} & Corte & AUC   & \begin{tabular}[c]{@{}c@{}}Presición \\ Global\end{tabular} & Especificidad & Sensibilidad \\ \hline
