...
$$Y_i = \beta_{0} + \beta_{1}  D_i + \beta_{2}  C_i + \beta_{3}  Hundidos_i + \beta_{4}  Otros_i 
+ \beta_{5}  Calidos_i + \beta_{6}  Frios_i + \beta_{7}  Ninguno_i + \beta_{8}  Oscuros = \eta_i$$ 

Donde $Y_i \sim Be(\pi_i)$ y $logit(\pi_i) = \eta_i$ 


Se estima el modelo y se llega a la siguiente formula:

$$logit(\hat{\pi_i}) = -0.20 + 0.06  D_i + 0.80  C_i + 0.07  Hundidos_i -1.40  Otros_i 
-0.85 Calidos_i -0.58  Frios_i -14.18  Ninguno_i - 1.27 Oscuros_i $$
